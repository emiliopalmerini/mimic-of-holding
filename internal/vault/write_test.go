...
func TestWriteFile_EmptyRef(t *testing.T) {
	_, err := WriteFile(searchFixture, "", "test.md", "content", "", nil)
	if err == nil {
...
func TestWriteFile_NonIDRef(t *testing.T) {
	_, err := WriteFile(searchFixture, "S01", "test.md", "content", "", nil)
	if err == nil {
...
func TestWriteFile_EmptyFilename(t *testing.T) {
	_, err := WriteFile(searchFixture, "S01.11.11", "", "content", "", nil)
	if err == nil {
...
func TestWriteFile_IDNotFound(t *testing.T) {
	_, err := WriteFile(searchFixture, "S01.11.99", "test.md", "content", "", nil)
	if err == nil {
