...
func TestCreate_EmptyName(t *testing.T) {
	_, err := Create(searchFixture, "S01.11", "", "", nil)
	if err == nil {
...
func TestCreate_InvalidCategoryRef_Scope(t *testing.T) {
	_, err := Create(searchFixture, "S01", "Cinema", "", nil)
	if err == nil {
...
func TestCreate_InvalidCategoryRef_Garbage(t *testing.T) {
	_, err := Create(searchFixture, "xyz", "Cinema", "", nil)
	if err == nil {
...
func TestCreate_InvalidCategoryRef_ID(t *testing.T) {
	_, err := Create(searchFixture, "S01.11.11", "Cinema", "", nil)
	if err == nil {
...
func TestCreate_CategoryNotFound(t *testing.T) {
	_, err := Create(searchFixture, "S99.99", "Cinema", "", nil)
	if err == nil {
